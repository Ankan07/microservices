...
public class KafkaAdminClient {
    ...
    private void checkMaxRetry(int retry, Integer maxRetry) {
        if(retry>maxRetry){
            throw new KafkaClientException("reavhed max no of retries for reading kafka topic(s)!");
        }
    }
    ...
    private CreateTopicsResult doCreateTopics(RetryContext retryContext) {
        ...
        LOG.info("Creating {} topic(s) atte,pt {}",topicNames.size(),retryContext.getRetryCount());
    ...
    private Collection<TopicListing> getTopics(){
        ...
        try {
            ...
            throw new KafkaClientException("Reached max no of retries for reading kafka topics",t);
        }
        return topics;
    }
